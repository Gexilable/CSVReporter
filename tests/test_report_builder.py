from app.report_builder import BaseReportBuilder
...
def test_report_builder_returns_correct_sorted_report():
    ...
    report_builder = BaseReportBuilder(data=test_data, sorting_parameter=sorting_parameter, descending_order=True)
...
def test_report_builder_returns_filtered_report():
    ...
    report_builder = BaseReportBuilder(data=test_data, filtering_parameter=filtering_parameter)
    result = report_builder.build()
